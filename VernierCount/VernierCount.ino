...
The sketch sums the "Blocked" events in the period "Duration". As written, the 
...
int duration = 10000;// this is the total time between reported results, the collect time
